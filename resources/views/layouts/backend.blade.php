...
<head>
    ...
    <title>{{ config('Mazadk', 'Mazadk') }}</title>
...
<body>
    <div id="app">
        ...
        <div class="container">
            &copy; {{ date('Y') }}. Created by <a href="https://www.facebook.com/h.alrakhawi" target="_blank">Eng. Hazem Alrakhawi</a>
            <br/>
        </div>
