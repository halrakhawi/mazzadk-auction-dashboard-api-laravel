        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ url('/admin/category/create') }}" class="btn btn-success btn-sm" title="Add New Setting">
                        ...
                        <div class="table-responsive">
                            ...
                            <div class="pagination-wrapper"> {!! $cats->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
